	...
	<script>
		...
		$(document).ready(function(){
			...
			$("#btnAgregar").click(function(){
				...
				var producto = 	'<tr><td class="prodAgregado">[<a href="#">X</a>] ' + $("#cboProducto option:selected").text() + '</td><td align="center">' + cantidad + '<input type="hidden" name="detalle[]" value="' + $("#cboProducto").val() + '-' + cantidad + '-' + '" /></td><td align="right">' + cantidad + '</td><td class="tdSubTotal" align="right">' + sub.toFixed(2) + '</td></tr>';
